...
- Include the Javascript file currently at location `bin/lighthigher.js` (you can use a CDN: `<script src="https://cdn.jsdelivr.net/gh/panglesd/lighthigher@master/bin/lighthigher.min.js"></script>`)
